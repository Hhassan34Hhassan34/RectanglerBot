    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so Rectangler doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Rectangler. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discordapp.com/oauth2/authorize?client_id=774701617928208405&scope=bot&permissions=8)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [Rectangler Support Server](https://discord.gg/NYu72SRGuK)!
        `)
        .setFooter('DM Hassan34.#1848 to speak directly with the developer!')
